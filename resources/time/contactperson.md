...
```JSON
{
	"id" : "d9535e2c-05fe-494c-ab7b-8a60aaddce98",
	"createdAt" : "/Date(1408461894526)/",
	"updatedAt" : "/Date(1408506714526)/",
	"version" : 9,
	"firstName" : "Pedro",
	"lastName" : "Examplo",
	...
	"client" : {
		"id" : "a8dedcf2-74d0-40c5-8de1-b1fd90a8db9b",
		"createdAt" : "/Date(1408459974526)/",
		"updatedAt" : "/Date(1408467114526)/",
		"version" : 9,
		"externalSystem" : {
			"id" : "457f97c0-c09c-4677-8bdb-2545d3f71f51",
			"createdAt" : "/Date(1408460814527)/",
			"updatedAt" : "/Date(1408524714527)/",
			"version" : 1,
			"name" : "Vendor system",
		...
		"externalSyncedAt" : "/Date(1408463514526)/",
		"externalSynced" : true,
		"name" : "Example Ltd.",
		"code" : "EXL",
